#script to export biom from qiime2 artifact and then copy the feature-biom to a new directory
#usage: python3 export_biom.py <artifact.qza> <output_dir>
...
def run_qiime_export(input_path, output_path, new_filename):
    ...
    # Copy everything inside the output directory to the new directory
    for item in os.listdir(output_path):
        source_file = os.path.join(output_path, "feature-table.biom")
...
if __name__ == "__main__":
    ...
    parent_parser.add_argument('--new-filename', help='rename the feature table biom', required=True)
    ...
    run_qiime_export(args.input_path, args.output_path, args.new_filename)
