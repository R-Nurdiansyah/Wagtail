#script to export qc_stats from qiime2 q-score artifact and then copy the stats.csv to a new directory
...
def qc_export(input_path, output_path, sample_name):
...
if __name__ == "__main__":
    ...
    parent_parser.add_argument('--input-path', help='location of the qiime qc artifact file', required=True)
